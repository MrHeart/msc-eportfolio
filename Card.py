...
class Deck:
    ...
    def deal_hands(self, num_hands, cards_per_hand):
        """Creates and returns a list of hands, each with the specified number of cards.

        num_hands: integer, number of hands to deal
        cards_per_hand: integer, number of cards per hand
        """
        hands = []
